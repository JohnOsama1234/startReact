  ...
  return (
    ...
    <section className="page-section portfolio mt-5 " id="portfolio">
        <div className="container">
            <h2 className="page-section-heading port-text text-center text-secondary mb-0">PORTFOLIO</h2>
            <div className="divider-custom">
                <div className="divider-custom-line"></div>
                <div className="divider-custom-icon text-center mt-3"><i className="fas fa-star"></i></div>
                <div className="divider-custom-line"></div>
            </div>
